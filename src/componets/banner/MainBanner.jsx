  ...
  return (
    <div>
      <div className='relative'> 
        <img src={assets.main_banner_bg} alt=" banner" srcset="" 
        className='w-full hidden md:block '
        />
         <img src={assets.main_banner_bg_sm} alt=" banner" srcset="" 
        className='w-full  md:hidden'
        />
        <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end
        md:justify-center pd-24 md:pd-0 px-4 md:pl-18 lg:pl-24'>
        ...
        <div className='flex items-center mt-6 font-medium'>
          ...
          bg-primary hover:bg-primary-dull transition rounded-md  text-white cursor-pointer'>
            Shop now
          ...
          />
           ...
           <Link to={'/products'} className='goup hidden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
            Explore deals
