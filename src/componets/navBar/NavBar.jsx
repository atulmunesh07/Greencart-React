        ...
        <div className="hidden sm:flex items-center gap-8">
          ...
          {!user ? (<button onClick={() => setShowUserLogin(true)}
            ...
            <div className=" relative group">
              <img src={assets.profile_icon} className="w-10" alt="user" srcset="" />
