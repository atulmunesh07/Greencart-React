...
function AddProduct() {
    ...
    const [offerPrice,setOfferPrince] = useState('')
  ...
  return (
    <div>
         <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onSumitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                <div>
                ...
                <div className="flex flex-col gap-1 max-w-md">
                    ...
                    //className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40 resize-none" placeholder="Type here"
                    >
                        
                    </textarea> */}
               
               {/* ------------description---------end--------use up------------------- */}
                </div>
                <div className="w-full flex flex-col gap-1">
                    <label className="text-base font-medium" htmlFor="category">Category</label>

                    {/* ------select tag --- use to up------------- */}
                    <select
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    ...
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        ...
                        {/* -----offer price -------------- */}
                        <input 
                        onChange={(e)=>setOfferPrince(e.target.value)} 
                         value={offerPrice}
